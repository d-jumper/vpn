...
echo -e ""
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
echo -e "     Add Domain for Server Nginx"
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
echo -e " "
echo -e " ${LIGHT}- ${NC}Creating Directory Nginx Server"
...
read -rp "Input ur domain / sub-domain : " -e domain
    ...
    Then a random sub-domain will be created${NC}"
    sleep 2
    rm /usr/bin/cf
    ...
    sleep 3
	echo -e "${domain}" > ${arfvpn}/domain
	echo -e "${domain}" > ${arfvpn}/scdomain
    echo -e "IP=${domain}" > ${ipvps}/ipvps.conf
    fi
    sleep 2
