...
clear 
    ...
    echo -e " ${LIGHT}- ${NC}Deleting User Vless Websocket"
    arfvpn_bar 'delvl'
...
#        fi
    ...
    echo -e "\033[0;34m└─────────────────────────────────────────────────────┘${NC}"
    echo ""
    echo -e "     ${LIGHT}Press ${NC}[ ENTER ]${LIGHT} to ${NC}${BIYellow}Back to Menu-vless${NC}${LIGHT} or ${NC}${RED}CTRL+C${NC}${LIGHT} to exit${NC}"
    read -p ""
    history -c
    clear
    menu-vless